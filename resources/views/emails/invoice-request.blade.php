...
<head>
    ...
    <title>Новая заявка: Получить счет с НДС</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>📄 Новая заявка на счет с НДС</h1>
            <p>[ {{ $submitted_at }} ]</p>
        </div>
        ...
        <div class="content">
            <div class="info-block">
                <div class="info-row">
                    ...
                    <span class="info-value highlight-value">{{ $company_name }}</span>
                </div>
                <div class="info-row">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">
                        <a href="tel:{{ $phone }}" style="color: #1f6c9f; text-decoration: none; font-weight: 600;">{{ $phone }}</a>
                    </span>
                </div>
                <div class="info-row">
                    <span class="info-label">E-mail:</span>
                    <span class="info-value">
                        <a href="mailto:{{ $email }}" style="color: #1f6c9f; text-decoration: none; font-weight: 600;">{{ $email }}</a>
                    </span>
                </div>
                <div class="info-row">
            ...
            <div class="message-block">
                <h3>💬 Детали заказа / Спецификация:</h3>
                <p>{{ $comment }}</p>
            </div>
            @endif
        </div>
        ...
        <div class="footer">
            ...
            <p>Свяжитесь с клиентом для отправки коммерческого предложения и счета.</p>
        </div>
    </div>
</body>
</html>
